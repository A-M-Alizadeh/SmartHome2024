...
class DataManager:
    ...
    def find_house_only_by_id(self,house_id):
        users = CatalogReader()["users"]
        for user in users:
            user_houses = user.get("houses", [])
            for house in user_houses:
    ...
    def new_house(self,user_id, house:House):
        users = CatalogReader()["users"]
        for user in users:
    ...
    #-------------------------------------------- Sensor CRUD --------------------------------------------
    def get_all_sensors(self,user_id, house_id):
        users = CatalogReader()["users"]
        for user in users:
            if user["user_id"] == user_id:
    ...
    def get_sensor_by_id(self,user_id, house_id, sensor_id):
        users = CatalogReader()["users"]
        for user in users:
            if user["user_id"] == user_id:
    ...
    def find_sensor_only_by_id(self,sensor_id):
        users = CatalogReader()["users"]
        for user in users:
            user_houses = user.get("houses", [])
            for house in user_houses:
    ...
    def new_sensor(self,user_id, house_id, sensor):
        users = CatalogReader()["users"]
        for user in users:
            if user["user_id"] == user_id:
    ...
    def updateSensorStatus(self,sensor_id, status):
        sensor = self.find_sensor_only_by_id(sensor_id)
    ...
    def update_house(self,user_id, house_id, house):
        return updateHouse(user_id, house_id, house)

    def update_sensor(self,user_id, house_id, sensor_id, sensor):
    ...
    def delete_house(self,user_id, house_id):
        return deleteHouse(user_id, house_id)

    def delete_sensor(self,user_id, house_id, sensor_id):
